            ...
            <div className="text-left">
              ...
              >
                ...
                <span className="bg-clip-text text-transparent bg-linear-to-r from-indigo-300 to-indigo-400">
                  the right prices, and a whole lot more.
                </span>
              </motion.h1>
              ...
              >
                Quality you can trust for years to come. Service that goes
                beyond the checkout button. Everything you need, all in one
                place.Elevating your everyday with curated excellence. Value
                that doesn't compromise on the details. More than a brand—it’s a
                lifestyle upgrade.
              </motion.p>
              ...
              >
                <a href="https://amzn.to/4lic8Le" className="w-full sm:w-auto">
                  <button className="w-36 lg:w-40 h-14 lg:h-15 px-2 lg:px-6 py-2 bg-white hover:bg-gray-300 active:scale-95 transition-all  max-sm:justify-center text-black text-xs lg:text-sm">
                    ...
                    <img
                      src={amazonLogo}
                      className="w-20 lg:w-24 h-7 lg:h-8 ml-2"
                    />
                  </button>
                </a>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2 p-2 px-3 sm:px-6.5 hover:bg-white/3 transition-colors">
                  ...
                  <div>
                    <div>Premium Quality You Can Trust</div>
                ...
                <div className="flex items-center gap-2 p-2 px-3 sm:px-6.5 hover:bg-white/3 transition-colors">
                  ...
                  <div>
                    <div>Crafted for Everyday Comfort</div>
                    <div className="text-xs text-gray-400">
                      Everyday Comfort
                    </div>
                  </div>
