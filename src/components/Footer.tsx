    ...
    >
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-white/10">
          <div>
            <img src="/Bslogo.png" alt="logo" className="h-8" />
            <p className="max-w-[410px] mt-6 text-sm leading-relaxed">
              Premium & reliable products for everyday use. Expertly crafted to
              last, designed to impress. Experience the quality you truly
              deserve.
            </p>
          </div>
        ...
        <p className="py-4 text-center text-sm text-gray-400">
          © {new Date().getFullYear()} <a href="/">Brand Sphere</a>. All rights
          reserved.
        </p>
      </div>
    </motion.footer>
